...
# Coeficientes
# ---------------------
print(f"Linear: coef={modelo_linear.coef_[0]}, intercepto={modelo_linear.intercept_}")
print(f"Polinomial (grau 2): coef={modelo_poly.coef_}, intercepto={modelo_poly.intercept_}")